class FlatsController < ApplicationController
  ...
  def index
    @flats = Flat.all
    @markers = @flats.geocoded.map do |geocoded_flat|
      {
        lon: geocoded_flat.longitude,
        lat: geocoded_flat.latitude,
        info_window: render_to_string(partial: "info_window", locals: { flat: geocoded_flat }),
